    ...
    return (
        <div className="mt-6 space-y-4">
            ...
            <div className="flex items-center justify-between gap-3 print:hidden">
                <button
                    onClick={() => router.back()}
                    className="inline-flex items-center gap-2 rounded-xl border border-[#1b4f94]/20 bg-[#1b4f94]/10 px-4 py-2 text-sm font-semibold text-[#1b4f94] hover:bg-[#1b4f94]/15 active:scale-95"
                >
                    <ArrowLeft size={16} />
                    Quay lại
                </button>
                ...
                <button
                    ...
                    className="inline-flex items-center gap-2 rounded-xl bg-[#1b4f94] px-4 py-2 text-sm font-semibold text-white hover:bg-[#1c4273] active:scale-95"
                >
                    <Printer size={16} />
                    In
                </button>
